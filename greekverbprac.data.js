...
window.VERBS = [
  ...
  { set: 5, english: 'play',            present: 'παίζω',       past: 'έπαιξα',       future: 'θα παίξω',        pastCont: 'έπαιζα',        futureCont: 'θα παίζω',       class: 'A',  family: '-ω / -σα (A regular)' },
  { set: 5, english: 'drive',           present: 'οδηγώ',       past: 'οδήγησα',      future: 'θα οδηγήσω',      pastCont: 'οδηγούσα',      futureCont: 'θα οδηγώ',       class: 'B2', family: '-ώ / -ησα (B2 contract)' },
  { set: 5, english: 'phone',           present: 'τηλεφωνώ',    past: 'τηλεφώνησα',   future: 'θα τηλεφωνήσω',   pastCont: 'τηλεφωνούσα',   futureCont: 'θα τηλεφωνώ',    class: 'B2', family: '-ώ / -ησα (B2 contract)' },
  { set: 5, english: 'consider',        present: 'θεωρώ',       past: 'θεώρησα',      future: 'θα θεωρήσω',      pastCont: 'θεωρούσα',      futureCont: 'θα θεωρώ',       class: 'B2', family: '-ώ / -ησα (B2 contract)' },
  { set: 5, english: 'live',            present: 'ζω',          past: 'έζησα',        future: 'θα ζήσω',         pastCont: 'ζούσα',         futureCont: 'θα ζω',          class: 'B2', family: '-ώ / -ησα (B2 contract)', classNote: 'monosyllabic contract: ζω, ζεις, ζει, ζούμε, ζείτε, ζουν.' },
  { set: 5, english: 'help',            present: 'βοηθάω',      past: 'βοήθησα',      future: 'θα βοηθήσω',      pastCont: 'βοηθούσα',      futureCont: 'θα βοηθάω',      class: 'B1', family: '-άω / -ησα (B1 contract)' },
  { set: 5, english: 'walk',            present: 'περπατάω',    past: 'περπάτησα',    future: 'θα περπατήσω',    pastCont: 'περπατούσα',    futureCont: 'θα περπατάω',    class: 'B1', family: '-άω / -ησα (B1 contract)' },
  { set: 5, english: 'smile',           present: 'χαμογελάω',   past: 'χαμογέλασα',   future: 'θα χαμογελάσω',   pastCont: 'χαμογελούσα',   futureCont: 'θα χαμογελάω',   class: 'B1', family: '-άω / -ησα (B1 contract)', classNote: 'aorist takes -ασα (γελάω → γέλασα), not -ησα.' },
  { set: 5, english: 'sleep',           present: 'κοιμάμαι',    past: 'κοιμήθηκα',    future: 'θα κοιμηθώ',      pastCont: 'κοιμόμουν',     futureCont: 'θα κοιμάμαι',    class: 'MP', family: '-ομαι / -θηκα (mediopassive)' },
  { set: 5, english: 'be afraid',       present: 'φοβάμαι',     past: 'φοβήθηκα',     future: 'θα φοβηθώ',       pastCont: 'φοβόμουν',      futureCont: 'θα φοβάμαι',     class: 'MP', family: '-ομαι / -θηκα (mediopassive)' },
  { set: 5, english: 'sense',           present: 'αισθάνομαι',  past: 'αισθάνθηκα',   future: 'θα αισθανθώ',     pastCont: 'αισθανόμουν',   futureCont: 'θα αισθάνομαι',  class: 'MP', family: '-ομαι / -θηκα (mediopassive)' }
];
...
window.CONJUGATIONS = {
  ...
  'sleep': {
    ...
    pastCont:  ['κοιμόμουν','κοιμόσουν','κοιμόταν','κοιμόμασταν','κοιμόσασταν','κοιμόνταν'],
  ...
  'be afraid': {
    ...
    pastCont:  ['φοβόμουν','φοβόσουν','φοβόταν','φοβόμασταν','φοβόσασταν','φοβόνταν'],
  ...
  'sense': {
    ...
    pastCont:  ['αισθανόμουν','αισθανόσουν','αισθανόταν','αισθανόμασταν','αισθανόσασταν','αισθανόνταν'],
